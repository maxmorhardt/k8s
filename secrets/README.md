...
Synced by the [secrets Application](../argocd/infra/secrets.yaml), which recurses over
this directory. Adding a secret is a new file here — nothing to apply by hand.
...
See [sealed-secrets/SETUP.md](../sealed-secrets/SETUP.md) for how to seal one.
